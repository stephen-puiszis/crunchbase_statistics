...
companies.each_index do |i|
  ...
  # WAT KUNNEN WE HIER MEE?!
        if round["investments"].empty?
          i = Investment.new
          i.funding_id = f.id + (number_of_queries * run_number)
          i.save
        end
        ...
        if investment["company"] != nil
          unless Company.find_by_perma(investment["company"]["permalink"]) == nil
            ...
            company.investments.create(funding_id: (f.id + (number_of_queries * run_number) ) )
          end
          ...
          unless Financial.find_by_perma(investment["financial_org"]["permalink"]) == nil
            ...
            financial.investments.create(funding_id: (f.id + (number_of_queries * run_number) ) )
            ...
            individual.investments.create(funding_id: (f.id + (number_of_queries * run_number) ) )
